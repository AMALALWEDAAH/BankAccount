...
Sara.deposit(10).deposit(20).deposit(30).withdraw(70).yield_interest().display_account_info()


print('User:nora')
nora.deposit(400).deposit(20).withdraw(20).withdraw(80).withdraw(200).withdraw(40).yield_interest().display_account_info()
